...
:Description:
    ...
    :code:`beam2ts` computes the section forces and displacements in local directions
    along the beam element :code:`beam2te`.

    The input variables :code:`ex`, :code:`ey`, :code:`ep` and :code:`eq` are defined in
    :code:`beam2te`. The element displacements, stored
...
:Theory:
    ...
    are defined in :code:`beam2te` and
