...
When the element nodal values have been computed, the section forces can be calculated using functions specific to the element type concerned. These functions are identified by their last letter :code:`-s`.
