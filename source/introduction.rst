...
.. only:: matlab
    ...
    where the two-by-two matrices :code:`A` and :code:`B` are added together, and the result is stored in matrix :code:`C`. The matrix :code:`B'` is the transpose of  :code:`B`. In MATLAB, the transpose operator is denoted by a single quote :code:`'`.
...
.. only:: python
    ...
    where the two-by-two matrices :code:`A` and :code:`B` are added together, and the result is stored in matrix :code:`C`. The matrix :code:`B.T` is the transpose of  :code:`B`. In Python, the transpose operator is denoted by a  :code:`T`.
