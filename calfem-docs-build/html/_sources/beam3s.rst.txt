...
:Theory:
    ...
    where :math:`\mathbf{G}` is described in ``beam3e`` and the transpose of :math:`\mathbf{a}^e` is stored in ``ed``.
    ...
    in which :math:`D_{EA}`, :math:`L`, and :math:`q_{\bar{x}}` are defined in ``beam3e`` and
    ...
    in which :math:`D_{EI_{\bar{z}}}`, :math:`L`, and :math:`q_{\bar{y}}` are defined in ``beam3e`` and
    ...
    in which :math:`D_{EI_{\bar{y}}}`, :math:`L`, and :math:`q_{\bar{z}}` are defined in ``beam3e`` and :math:`\mathbf{N}_{\text{beam}}`, :math:`\mathbf{B}_{\text{beam}}`, and :math:`\frac{d\mathbf{B}_{\text{beam}}}{dx}` are given above.
    ...
    in which :math:`D_{GK}`, :math:`L`, and :math:`q_{\omega}` are defined in ``beam3e``.
