...
:Description:
    ...
    :code:`bar3e` provides the global element stiffness matrix :math:`{\mathbf{K}}^e` for a three dimensional bar element.
    ...
    The element load vector :code:`fe` can also be computed if a uniformly distributed axial load is applied to the element. The optional input variable
