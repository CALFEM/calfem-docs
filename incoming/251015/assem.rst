...
:code:`assem` adds the element stiffness matrix 
:math:`\mathbf{K}^e`, stored in :code:`Ke`, to the structure stiffness matrix :math:`\mathbf{K}`, stored in :code:`K`, according to the topology matrix :code:`edof`.
